...
class DetailKUMFulfillmentFragment: BaseFragment<DetailKUMViewModel>() {
    ...
    companion object {
        fun newInstance(id: String, isKawin: Boolean = false) = DetailKUMFulfillmentFragment().apply {
            arguments = bundleOf(
                "ID" to id,
                "IS_KAWIN" to isKawin
            )
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDetailKumFulfillmentBinding.inflate(inflater, container, false)
        return binding.root
    }
