...
@Inject constructor(
    ...
    fun detailKURDocument(id: String): Single<Response<MutableList<DetailKURDocument>>> {
        return api.detailKURDocument(getIdMember(), id)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
    }

    fun detailKURFulfillment(id: String): Single<Response<MutableList<DetailKURFulfillment>>> {
        return api.detailKURFulfillment(getIdMember(), id)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
    }

    fun detailKURPrescreening(id: String): Single<Response<MutableList<DetailKURPrescreening>>> {
        return api.detailKURPrescreening(getIdMember(), id)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
    }

    fun detailKUMPrescreening(id: String): Single<Response<MutableList<DetailKUMPrescreening>>> {
        return api.detailKUMPrescreening(getIdMember(), id)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
    }

    fun detailKUMFulfillment(id: String): Single<Response<MutableList<DetailKUMFulfillment>>> {
        return api.detailKUMFulfillment(getIdMember(), id)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
    }
